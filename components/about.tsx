...
export default function About() {
   return (
      <section className='w-full my-24 md:px-0'>
         <div className='flex justify-center items-center my-4 p-4 md:p-8 bg-card/80 backdrop-blur-sm rounded-lg'>
            <div className='p-2 flex-[2] text-center md:text-left text-secondary-foreground/80'>
               ...
               <p className='py-4 md:text-xl md:mr-6 leading-relaxed text-secondary-foreground/70'>
                  ...
                  slick, full-stack applications. With a curiosity for AI
